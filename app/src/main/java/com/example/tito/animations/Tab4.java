...
public class Tab4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      leftin= AnimationUtils.loadAnimation(getActivity(),R.anim.card_flip_left_in);
        cardView2=(CardView)rootView.findViewById(R.id.card_view2);
        leftout= AnimationUtils.loadAnimation(getActivity(),R.anim.card_flip_left_out);
        cardView3=(CardView)rootView.findViewById(R.id.card_view3);
        rightin= AnimationUtils.loadAnimation(getActivity(),R.anim.card_flip_right_in);
        cardView4=(CardView)rootView.findViewById(R.id.card_view4);
        rightout= AnimationUtils.loadAnimation(getActivity(),R.anim.card_flip_right_out);
        cardView1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

               cardView1.setVisibility(View.VISIBLE);
                cardView1.startAnimation(leftin);
            }
        });
        cardView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cardView2.startAnimation(leftout);
            }
        });
        ...
        cardView3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cardView3.startAnimation(rightin);
            }
        });
        ...
        cardView4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cardView4.startAnimation(rightout);
